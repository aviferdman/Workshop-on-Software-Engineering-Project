...
namespace TradingSystemTests.IntegrationTests.ConcurrentTests
{
    ...
    public class UserManagementConcurrentTests
    {
        ...
        public void TestConcurrentSignup()
        {
            String val1 = "";
            String val2 = "";
            Task task1 = Task.Factory.StartNew(() => val1 = UserManagement.Instance.SignUp("inbi2001", "123456", new Address("lala", "lala", "lala", "la", "1111111"), "0501234733"));
            Task task2 = Task.Factory.StartNew(() => val2 = UserManagement.Instance.SignUp("inbi2001", "123456", new Address("lala", "lala", "lala", "la", "1111111"), "0501234733"));
        ...
        public void TestConcurrentSignupLoop()
        {
            for(int i = 0; i<1000; i++)
            {
                ...
                Task task1 = Task.Factory.StartNew(() => val1 = UserManagement.Instance.SignUp("inbi2001", "123456", new Address("lala", "lala", "lala", "la", "1111111"), "0501234733"));
                Task task2 = Task.Factory.StartNew(() => val2 = UserManagement.Instance.SignUp("inbi2001", "123456", new Address("lala", "lala", "lala", "la", "1111111"), "0501234733"));
                Task task3 = Task.Factory.StartNew(() => val3 = UserManagement.Instance.SignUp("inbi2001", "123456", new Address("lala", "lala", "lala", "la", "1111111"), "0501234733"));
