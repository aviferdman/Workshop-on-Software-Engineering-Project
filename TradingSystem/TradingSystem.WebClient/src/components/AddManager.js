...
class AddManager extends React.Component {
    ...
    onConfirm = e => {
        ...
        api.stores.permissions.appointManager(this.context.username, this.props.storeId, assignee)
            .then(() => {
                this.setState({
                    show: false,
                    nameField: new FormFieldInfo(),
    ...
    render() {
        return (
            <main className="items">
                ...
                <button className= "store-products-button-view" onClick={this.showModal}> Add Manager </button>
            </main>
        )
    }
}
        ...
        <div className={showHideClassName}>
            <section className='modal-main'>
                ...
                <div className="lines-props">
                    <h2 className="center-text">Add Manager</h2>
                    {children}
                </div>
...
AddManager.contextType = GlobalContext;
