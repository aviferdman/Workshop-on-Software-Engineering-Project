...
namespace TradingSystem.Service
{
    class MarketRulesService
    {
        ...
        public Guid CreateRule(RuleContext ruleContext, RuleType ruleType, string category = "", Guid productId = new Guid(), string username = "", double valueLessThan = int.MaxValue, double valueGreaterEQThan = 0, DateTime d1 = new DateTime(), DateTime d2 = new DateTime())
        {
            var r = marketRules.CreateRule(ruleContext, ruleType, category, productId, username, valueLessThan, valueGreaterEQThan, d1, d2);
            rules.Add(r);
            return r.GetId();
        }
